    ...
    $(document).ready(function(){
      function addClickToEachImage(wid){
        $("#wid"+wid).click(function(){
            ...
            $.get("/admin/api/work/show", {wid: wid}, function(res){
                ...
                $("#m-thumbnail").attr("src", "/Public/thumb/"+res.thumbnail);
      ...
      function response_deal(response){
        ...
        for(var i=0; i<response.length; i++)
        {
          ...
          var dom_image = '<a class="image image-show-details" id="wid'+response[i].wid+'"><img src="/Public/thumb/'+response[i].thumbnail+'" width="200px"></a>';
