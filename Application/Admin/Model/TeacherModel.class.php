...
class TeacherModel extends UserModel {
  ...
  public function getList($num, $page){
    $res = $this->where("valid='1' AND role='1'")->order("updatetime desc")->limit(($page-1)*$num, $num)->getField("uid, truename, sex, img, major, school, createtime, birth, constellation, profile, location");
    return $res;
  }
